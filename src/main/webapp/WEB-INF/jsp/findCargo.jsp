...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header"> Find Cargo</h3>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <div class="row">
            <div class="col-lg-6">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <form:form role="form" method="post" action="listCargo" onsubmit="return checkForm(this);">
                            <fieldset>
                                <div class="form-group">
                                    <div class="form-group">
                                        <label>Cargo ID</label>
                                        <input class="form-control" placeholder="Enter cargo ID" name="cargoId" autofocus>
                                    </div>
                                </div>
                        ...
                        <script>
                            ...
                            function checkForm(form)
                            {
                                ...
                                if(form.cargoId.value == "" || form.cargoId.value == null) {
                                    alert("Error: cargoId should not be empty");
                                    form.cargoId.focus();
                                    return false;
                                }

                                // validation fails if the input doesn't match our regular expression
                                if(!re.test(form.cargoId.value)) {
                                    alert("Error: cargoId should be numeric with and at least 1 character");
                                    form.cargoId.focus();
                                    return false;
                                }
