...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header"> Find Order</h3>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <div class="row">
                    ...
                    <div class="panel-body">
                            ...
                            <fieldset>
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="Enter order ID" name="orderId" autofocus>
                                    </div>
                                </div>
                        ...
                        <script>
                            ...
                            function checkForm(form)
                            {
                                ...
                                if(form.orderId.value == "" || form.orderId.value == null) {
                                    alert("Error: orderId should not be empty");
                                    form.orderId.focus();
                                    return false;
                                }

                                // validation fails if the input doesn't match our regular expression
                                if(!re.test(form.orderId.value)) {
                                    alert("Error: orderId should be numeric and at least 1 character");
                                    form.orderId.focus();
                                    return false;
                                }
